...
class TextStage extends React.Component {
  constructor(props) {
    ...
    strangs[3] = "He came out of nothingness, took form, was loved.";
    ...
    strangs[7] = "All night the dark buds of dreams open richly.";
    strangs[8] = "Should have been a pair of ragged claws, scuttling across the floors of silent seas.";
    strangs[9] = "if you could only remember and string them all together.";
    strangs[10] = "All that we see or seem Is but a dream within a dream.";
    strangs[11] = "We are such stuff as dreams are made of.";
    strangs[12] = "A dream itself is but a shadow.";
    strangs[13] = "If we shadows have offended, think but this and all is mended.";
    strangs[14] = "Dreams predict the future we don't realize we can already see."
